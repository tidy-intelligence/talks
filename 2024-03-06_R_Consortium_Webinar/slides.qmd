...
3. Embrace functional programming to create reproducible results
4. Reuse existing data structures across applications
...
- Reach out via **contact@tidy-finance.org**

# Wrap-up

## Tidy approach to teaching & research

A simpler way to access financial data in a tidy way:
